...
To evaluate the pairwise competitive outcome, We first do so by directly comparing the mean niche and fitness differences within species pairs. Below shows the resulting percentage of species pairs in which soil microbes are predicted to drive coexistence, competitive exclusion, and priority effects.
